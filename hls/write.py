...
portHandler = PortHandler('/dev/ttyUSB1')# ex) Windows: "COM1"   Linux: "/dev/ttyUSB0" Mac: "/dev/tty.usbserial-*"
...
while 1:
    ...
    # torque=500
    scs_comm_result, scs_error = packetHandler.WritePosEx(17, 800, 30, 50, 300)
